...
class MangaConverterGUI(QMainWindow):
    ...
    def start_conversion(self):
        ...
        self.worker_thread = worker_thread.WorkerThread(self.selected_path, process_mode, delete_images, self.settings)
    ...
    def open_settings(self):
        ...
        self.settings_window = settings_gui.SettingsGUI(parent=self, current_settings=self.settings.copy())
