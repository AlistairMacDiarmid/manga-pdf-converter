...
class SettingsGUI(QWidget):
    ...
    def create_pdf_settings_tab(self):
        ...
        quality_label.setStyleSheet("background-color: #353535;")

        quality_desc = QLabel("Higher values = better quality but larger file size")
        quality_desc.setStyleSheet("font-size: 11px; color: #aaaaaa; background-color: #353535;")
        ...
        self.compression_checkbox.setStyleSheet("background-color: #353535;")
    ...
    def create_image_settings_tab(self):
        ...
        process_desc.setStyleSheet("font-size: 12px; color: #cccccc; margin-bottom: 10px;")
        ...
        res_desc.setStyleSheet("font-size: 12px; color: #cccccc; margin-bottom: 10px;")
    ...
    def create_output_settings_tab(self):
        ...
        delete_warning.setStyleSheet("color: #d32f2f; font-size: 11px; font-weight: bold;")
    ...
    def apply_dark_theme(self):
        """apply dark theme to match the main window"""
        self.setStyleSheet("""
            QWidget {
